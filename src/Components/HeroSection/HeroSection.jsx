          ...
          <div className="container">
            <div className="hero">
              <div className="content-holder">
                <div
style={{
    WebkitTransform: 'translate3d(0, 45px, 0) scale3d(0.96, 0.96, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)',
    MozTransform: 'translate3d(0, 45px, 0) scale3d(0.96, 0.96, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)',
    msTransform: 'translate3d(0, 45px, 0) scale3d(0.96, 0.96, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)',
    transform: 'translate3d(0, 45px, 0) scale3d(0.96, 0.96, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)',
    opacity: 1,
  }}
...
style={{
    ...
    transformStyle: 'preserve-3d'
          ...
          <div className="bg-holder">
            <div
              data-poster-url="https://cdn.prod.website-files.com/67f82974e65f89a3c0ca8b7c%2F6806b1a9934255cdbea583c4_7031039_Above_Abstract_3840x2160_1-poster-00001.jpg"
              data-video-urls="https://cdn.prod.website-files.com/67f82974e65f89a3c0ca8b7c%2F6806b1a9934255cdbea583c4_7031039_Above_Abstract_3840x2160_1-transcode.mp4,https://cdn.prod.website-files.com/67f82974e65f89a3c0ca8b7c%2F6806b1a9934255cdbea583c4_7031039_Above_Abstract_3840x2160_1-transcode.webm"
              data-autoplay="true"
              data-loop="true"
              data-wf-ignore="true"
            ...
            >
              <video
                id="934e5c47-5756-55b8-064b-e14609d23f08-video"
                autoPlay
                loop
                muted
                playsInline
                style={{
                    backgroundImage: "url('https://cdn.prod.website-files.com/67f82974e65f89a3c0ca8b7c%2F6806b1a9934255cdbea583c4_7031039_Above_Abstract_3840x2160_1-poster-00001.jpg')"
                  }}
                data-wf-ignore="true"
      ...
      <div className="company-logo-wrapper">
        <div className="company-logo-holder">
          ...
          <div className="fade-in-on-scroll">
            <div className="container _100width"><div className="line"></div></div>
          </div>
        </div>
      </div>
    </div>
