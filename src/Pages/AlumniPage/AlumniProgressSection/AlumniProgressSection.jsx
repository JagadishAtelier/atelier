          ...
          <div className="prog-progress-layout">
            ...
            <div className="prog-section-heading progress-heading">
              ...
              <div className="prog-progress-text-wrap">
                ...
                Progress is more than just milestones—it's about growth, 
                    learning, and impact.
                </p>
              </div>
              ...
              <ul className="prog-progress-list-wrap">
                ...
                Monitor career advancements, skills, and achievements
                </li>
                <li className="prog-progress-list">
                Stay updated with alumni success stories and progress reports
                </li>
                <li className="prog-progress-list last">
                Gain insights to guide future goals and inspire others
                </li>
              </ul>
...
export default AlumniProgressSection
