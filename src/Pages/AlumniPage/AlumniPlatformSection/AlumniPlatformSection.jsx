...
import './AlumniPlatformSection.css'
import { Link } from 'react-router-dom';
function AlumniPlatformSection() {
  return (
        ...
        <div className="pla-container">
          ...
          <div className="pla-section-heading platform-heading">
            ...
            <div className="pla-common-title-wrap">
              ...
              One platform to connect, engage & grow your alumni network
              </h1>
            </div>
          </div>
          ...
          <div className="pla-platform-layout">
            ...
            <div className="pla-platform-item-2">
              <div className="pla-platform-item-content">
                <div className="pla-platform-item-title-wrap">
                  <p className="pla-platform-item-title">Alumni Engagement Hub</p>
                </div>
                <div className="pla-platform-item-text-wrap">
                  <p className="pla-platform-item-text">
                  Build a thriving alumni community with tools for networking, mentorship, 
                      event participation, and knowledge sharing in one centralized hub.
                  </p>
                </div>
              </div>
            ...
            <div className="pla-platform-item-2">
              <div className="pla-platform-item-content">
                <div className="pla-platform-item-title-wrap">
                  <p className="pla-platform-item-title">Smart Placement Management</p>
                </div>
                <div className="pla-platform-item-text-wrap">
                  <p className="pla-platform-item-text">
                  Simplify campus recruitment with placement drives, recruiter management, 
                      interview scheduling, and real-time analytics to maximize student success.
                  </p>
                </div>
              </div>
              <div className="pla-platform-item-thumb-wrap">
          ...
          <div className="pla-platform-layout-3">
            <div className="pla-platform-item-content-2">
              <div className="pla-platform-item-title-wrap-2">
                <p className="pla-platform-item-title-2">Stay connected. Drive opportunities.</p>
              </div>
              <ul role="list" className="pla-platform-item-list-wrap">
                <li className="pla-platform-item-list">
                Engage alumni with networking, mentorship & events
                </li>
                <li className="pla-platform-item-list">
                Boost placements with recruiter partnerships & insights
                </li>
                <li className="pla-platform-item-list last">
                Strengthen global presence through alumni success stories
                </li>
              </ul>
...
export default AlumniPlatformSection
