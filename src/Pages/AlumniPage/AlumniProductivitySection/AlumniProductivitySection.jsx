...
import './AlumniProductivitySection.css'
          ...
          <div className="prod-progress-layout-2">
            <div className="prod-section-heading progress-heading-2">
              ...
              <div className="prod-common-title-wrap">
                ...
                Empowering alumni to achieve more together
                </h1>
              </div>
              <div className="prod-progress-text-wrap">
                <p className="prod-features-text">
                Our platform helps alumni stay connected, collaborate on opportunities, 
                    and contribute to meaningful initiatives.
                </p>
              </div>
              <ul role="list" className="prod-progress-list-wrap">
                <li className="prod-progress-list">
                Collaborate on projects, mentorship, and career opportunities
                </li>
                <li className="prod-progress-list">
                Access resources, events, and workshops tailored for alumni
                </li>
                <li className="prod-progress-list last">
                Build stronger professional and social networks that last a lifetime
                </li>
              </ul>
            ...
            <div className="prod-progress-thumb-wrap">
              <img
                ...
                srcSet="
                https://shiminly.com/wp-content/uploads/2023/02/empower_students.jpg   500w,
                https://shiminly.com/wp-content/uploads/2023/02/empower_students.jpg  800w,
                https://shiminly.com/wp-content/uploads/2023/02/empower_students.jpg 1080w,
                https://shiminly.com/wp-content/uploads/2023/02/empower_students.jpg 1600w,
                https://shiminly.com/wp-content/uploads/2023/02/empower_students.jpg  1641w
                "
              />
            </div>
          </div>
...
export default AlumniProductivitySection
