...
import './RndProductivitySection.css'
import { Link } from 'react-router-dom';
function RndProductivitySection() {
  return (
        ...
        <div className="prod-container">
          <div className="prod-progress-layout-2">
            ...
            <div className="prod-progress-thumb-wrap">
              <img
                src="https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg"
                loading="lazy"
                alt="thumb-6"
                className="prod-progress-thumb"
                sizes="(max-width: 1641px) 100vw, 1641px"
                srcSet="
                https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg   500w,
                https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg   800w,
                https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg 1080w,
                https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg 1600w,
                https://accelmg.com/wp-content/uploads/2020/05/Beyond_TTM_small.jpg       1641w
                "
              />
            </div>
          </div>
...
export default RndProductivitySection
