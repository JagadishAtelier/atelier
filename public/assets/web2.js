...
(self.webpackChunk = self.webpackChunk || []).push([["90"], {
    4345: function(e, t, i) {
        ...
        a.define("slider", e.exports = function(e, t) {
            var i, o, d, l = {}, f = e.tram, u = e(document), c = a.env(), h = ".w-slider", v = "w-slider-force-show", m = r.triggers, p = !1;
            function g() {
                if (!(i = u.find(h)).length)
                    return;
                if (i.each(b),
                !d)
                    x(),
                    function() {
                        a.resize.on(w),
                        a.redraw.on(l.redraw)
                    }()
            }
            function x() {
                a.resize.off(w),
                a.redraw.off(l.redraw)
            }
            l.ready = function() {
                o = a.env("design"),
                g()
            ...
            function b(t, i) {
                ...
                r.mask.attr("id", n)),
                !o && !r.ariaLiveLabel && (r.ariaLiveLabel = e('<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />').appendTo(r.mask)),
                ...
                r.nav.off(h),
                y(r),
                o ? (r.el.on("setting" + h, O(r)),
                E(r),
                r.hasTimer = !1) : (r.el.on("swipe" + h, O(r)),
            ...
            function R(t, i, a) {
                return function(r) {
                    ...
                    t.hasTimer && E(t)) : (t.ariaLiveLabel.attr("aria-live", "off"),
                    t.hasTimer && C(t))
                }
            }
            function T(e, t) {
            ...
            function O(i) {
                return function(r, s) {
                    ...
                    if ("swipe" === r.type)
                        return u.disableSwipe || a.env("editor") ? void 0 : "left" === s.direction ? A(i)() : "right" === s.direction ? W(i)() : void 0;
                    if (i.nav.has(r.target).length) {
                        ...
                        "keydown" === r.type)
                            ...
                            case n.ARROW_LEFT:
                            case n.ARROW_UP:
                                I(i.nav, Math.max(c - 1, 0)),
                                r.preventDefault();
                                break;
                            case n.ARROW_RIGHT:
                            case n.ARROW_DOWN:
                                I(i.nav, Math.min(c + 1, i.pages)),
                                r.preventDefault();
                                break;
                            case n.HOME:
                                I(i.nav, 0),
            ...
            function L(t, i) {
                ...
                var n = i.index
                  , d = {};
                n < 0 ? (n = r.length - 1,
                a.infinite && (d.x = -t.endX,
                d.from = 0,
                d.to = r[0].width)) : n >= r.length && (n = 0,
                a.infinite && (d.x = r[r.length - 1].width,
                ...
                var u = t.offsetX || 0
                  ...
                  , R = "opacity " + y + "ms " + b
                  , T = "transform " + y + "ms " + b;
                if (v.find(s).removeAttr("tabindex"),
                ...
                if (t.index !== t.previous) {
                    if (!o && t.ariaLiveLabel.text(`Slide ${n + 1} of ${r.length}.`),
                    "cross" === w) {
                    ...
                    a.infinite && d.x ? (f(t.slides.not(g)).set({
                        visibility: "",
                        x: d.x
                    }).add(T).start({
                        x: c
            ...
            function M(t) {
                ...
                function(t) {
                    var i, a = [], r = t.el.attr("data-nav-spacing");
                    r && (r = parseFloat(r) + "px");
                    for (var n = 0, s = t.pages; n < s; n++)
                        (i = e('<div class="w-slider-dot" data-wf-ignore />')).attr("aria-label", "Show slide " + (n + 1) + " of " + s).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
